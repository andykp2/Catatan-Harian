...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editUsername = findViewById(R.id.edt_username2);
        editPassword = findViewById(R.id.edt_password2);
        editEmail = findViewById(R.id.edt_email);
        editNamaLengkap = findViewById(R.id.edt_nama);
        editAsalSekolah = findViewById(R.id.edt_asal_sekolah);
